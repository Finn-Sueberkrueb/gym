...
def startRoboSkate(port, graphics_environment):
    if graphics_environment:
        ...
        if platform == "darwin":
            os.system("nohup ../games/RoboSkate.app/Contents/MacOS/RoboSkate -screen-height 200 -screen-width 300 -p " + str(port) + " > RoboSkate" + str(port) + ".log &")
        elif platform == "linux" or platform == "linux2":
            os.system("nohup ../games/RoboSkate/roboskate.x86_64 -screen-height 200 -screen-width 300 -p " + str(port) + " > RoboSkate" + str(port) + ".log &")
        elif platform == "win32":
        ...
        if platform == "darwin":
            os.system("nohup ../games/RoboSkate.app/Contents/MacOS/RoboSkate -nographics -batchmode -p " + str(port) + " > RoboSkate" + str(port) + ".log &")
        elif platform == "linux" or platform == "linux2":
            os.system("nohup ../games/RoboSkate/roboskate.x86_64 -nographics -batchmode  -p " + str(port) + " > RoboSkate" + str(port) + ".log &")
        elif platform == "win32":
            # TODO: Running RoboSkate on windows in the background has not been tested yet!
            pass
